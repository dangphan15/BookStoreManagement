...
public class BlogDAO implements Serializable {
    ...
    public boolean createBlog(String author, String isbn, String title, String thumbnail, String content)
        ...
        try {
            ...
            if (con != null) {
                String sql = "INSERT INTO [blogs] ([author], [ISBN], [title], [content], [posted_time], [status], [thumbnail]) "
                        + "VALUES (?, ?, ?, ?, ?, ?, ?) ";
        ...
        try {
            ...
            if (con != null) {
                String sql = "SELECT [id], [author], u.[full_name] AS [author_fullname], \n"
                        + "[title], [content], [posted_time], [staff], [status], [thumbnail]\n"
                ...
                while (rs.next()) {
                    ...
                    BlogDTO blog = new BlogDTO(id, title, thumbnail, content, isbn, author, authorFullname, staff, postedTime, status);
                    blog.setBookName(bookDAO.getBookByISBN(isbn).getName());
                    if (result == null) {
        ...
        try {
            ...
            if (con != null) {
                ...
                if (rs.next()) {
                    ...
                    String staff = rs.getString("staff");
                    String status = rs.getString("status");
                    result = new BlogDTO(id, title, thumbnail, content, isbn, author, authorFullname, staff, postedTime, status);
                }
            }
        } finally {
            if (rs != null) {
