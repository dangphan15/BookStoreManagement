...
@WebServlet(name="FilterBlogsController", urlPatterns={"/admin/FilterBlogsController"})
public class FilterBlogsController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            Logger.getLogger(FilterBlogsController.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
