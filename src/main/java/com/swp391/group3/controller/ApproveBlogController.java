...
@WebServlet(name = "ApproveBlogController", urlPatterns = {"/admin/ApproveBlogController"})
public class ApproveBlogController extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String url = AppConstants.BlogFeatures.VIEW_BLOGS_CONTROLLER;
        ...
        try {
            ...
            if (session != null) {
                ...
                if (user != null) {
                    ...
                    String staff = user.getUsername();
                    dao.approveBlogById(id, staff);
                }
            }
        } catch (ClassNotFoundException | SQLException | NamingException ex) {
            Logger.getLogger(ApproveBlogController.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
