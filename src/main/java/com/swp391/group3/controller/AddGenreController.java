 ...
 * @author ACER
 */
@WebServlet(name = "/admin/AddGenreController", urlPatterns = {"/admin/AddGenreController"})
public class AddGenreController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String genreDes = request.getParameter("genreDes");

            if (genreDAO.checkGenreByName(genreName) == null) {
                genreDAO.insertGenres(genreName, genreDes);
                request.setAttribute("MESSEGE", "Add successfully!");
            }else{
                request.setAttribute("MESSEGE", "Genres has been existed!!!");
            }
