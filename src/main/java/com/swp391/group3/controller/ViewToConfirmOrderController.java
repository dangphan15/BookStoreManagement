...
@WebServlet(name="ViewToConfirmOrderController", urlPatterns={"/admin/ViewToConfirmOrderController"})
public class ViewToConfirmOrderController extends HttpServlet {
   
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String url = AppConstants.ToConfirmOrderFeatures.VIEW_ORDERS_PAGE;
        try {
            String status = AppConstants.OrderStatus.TO_CONFIRM;
