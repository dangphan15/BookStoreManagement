 ...
 * @author QuanMX
 */
public class ViewCancelledOrderController extends HttpServlet {


    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String url = AppConstants.CancelledOrderFeatures.CANCELLED_ORDER_PAGE;
        try {
            String status = AppConstants.OrderStatus.CANCELLED;
            //1. Call DAO
