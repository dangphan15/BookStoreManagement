                ...
                <div class="container">
                    <nav class="mb-3" style="--bs-breadcrumb-divider: '>';border-bottom: 1px solid whitesmoke !important;" aria-label="breadcrumb">
                        <ol class="breadcrumb" style="margin-bottom: 8px">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a style="color:#02027d!important;font-weight: bolder; font-size: 18px !important;" href="viewCompletedOrderAction">Completed</a></li>
                        </ol>
                    </nav>
