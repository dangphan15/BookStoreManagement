            ...
            <div class="order-container">
                ...
                <div class="container">
                    <nav class="mb-3" style="--bs-breadcrumb-divider: '>';border-bottom: 1px solid whitesmoke !important;" aria-label="breadcrumb" >
                        <ol class="breadcrumb" style="margin-bottom: 8px">
                            ...
                            <c:if test="${orders[0].status == 'To Confirm'}">
                                <li class="breadcrumb-item"><a style="color:#02027d!important; font-weight: bolder; font-size: 18px !important;" href="viewToConfirmOrderAction">To Confirm</a></li>
                            </c:if>
                            <c:if test="${orders[0].status == 'To Ship'}">
                                <li class="breadcrumb-item"><a style="color:#02027d!important;font-weight: bolder; font-size: 18px !important;"  href="viewToShipOrderAction">To Ship</a></li>
                            </c:if>
                            <c:if test="${orders[0].status == 'To Receive'}">
                                <li class="breadcrumb-item"><a style="color:#02027d!important;font-weight: bolder; font-size: 18px !important;" href="viewToReceiveOrderAction">To Receive</a></li>
                            </c:if>
                    ...
                    <c:if test="${not empty orders}">
                        ...
                        <table id="example-table-admin" class="table table-light table-hover table-borderless table-striped">
