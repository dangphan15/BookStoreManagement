                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="detail-infor">
                            <div class="row">
                                <h5><b>Shipping informaton</b></h5>
                                <ul class="list-group">


                                    <li class="list-group-item">
                                        <span style="font-weight: bold">Receiver name:</span> ${orderDto.receiverName} <br>
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    <c:if test="${not empty orderDto.deliveryCompany}">
                                        <li class="list-group-item">
                                            <span style="font-weight: bold">Delivery company:</span> ${orderDto.deliveryCompany} <br>
                                        </li>
                                    </c:if>
                                    ...
                                    <c:if test="${not empty orderDto.staffUsername}">
                                        <li class="list-group-item">
                                            <span style="font-weight: bold">Staff:</span> ${orderDto.staffUsername} <br>
                                        </li>
                                    </c:if>
                                </ul>
                                    ...
                                    <tbody>
                                        <c:forEach var="book" items="${books}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        <fmt:formatNumber value="${book.price * book.quantity}" type="currency" />
                                                    </span>
                                                </td>
                                            </tr>
                                        </c:forEach>
                    ...
                    <div class="col-md-4">
                        <div class="order-action">
                            ...
                            <div ><b>Time:</b> <fmt:formatDate type = "both" 
                                            dateStyle = "short" timeStyle = "short" value = "${orderDto.orderTime}" /></div>
                            ...
                            <c:if test="${orderDto.status == 'To Receive'}">
                                ...
                                <div >
                                    <form action="setExpectedReceiveDateAction" method="POST">
                                        <label><b>Expected Date:</b> <input class="form-control" type="date" name="expectedDate" value="" style="display: inline-block;width: 55%" /></label>
                            ...
                            <c:if test="${orderDto.status != 'Completed' && orderDto.status != 'Cancelled' && orderDto.status != 'Return/Refund'}">
                                <div >
                                    <form id="approvalForm" action="${approvalContextPath}" method="POST">
                                        <input style="width: 100%" class="btn btn-success" type="submit" value="${orderDto.status != "To Receive" ? "Approval order" : "Shipped"}"
                                               name="btAction" form="approvalForm" />
                                        <input type="hidden" name="id" value="${orderDto.orderId}" />
                                    </form>
                                    <c:if test="${not empty requestScope.ERRORS && requestScope.ORDER_ID == orderDto.orderId}">
                                        <p style="color: red;">${requestScope.ERRORS}</p>
                                    </c:if>
                                </div>
                                <div >
                                    <form action="${cancelContextPath}" method="POST">
                                        ...
                                        <input class="form-control ms-1" type="text" name="txtNote" style="width: 55%; display: inline-block"/>
                                        <input class="btn btn-danger" type="submit" value="Cancel order" name="btnAction" />
