        ...
        <jsp:include page="include/include_header.jsp"></jsp:include>
            <style>
                ...
                body {
                    ...
                    background:
                        linear-gradient(0deg, rgba(255, 244, 247, 0.5) 0%, rgba(255, 244, 247, 0.5) 100%, rgba(255, 244, 247, 0.5) 100%),
    ...
    <div class="container bg-white book-container">
        ...
        <div style="text-align: center">
            <nav class="paging-bar" aria-label="Page navigation">
                <ul class="pagination">
                    <li class="page-item">
                        <a class="page-link" onclick="loadPage('${requestScope.PAGE - 1}')" aria-label="Previous">
                            <span aria-hidden="true">«</span>
                        </a>
                    </li>
                    <c:forEach begin="1" end="${requestScope.NUM_OF_PAGE}" varStatus="counter">
                        <c:if test="${counter.count != requestScope.PAGE}">
                            <li class="page-item"><a class="page-link"  onclick="loadPage('${counter.count}')">${counter.count}</a></li>
                            </c:if>
                            <c:if test="${counter.count == requestScope.PAGE}">
                    ...
                    <li class="page-item">
                        <a class="page-link" onclick="loadPage('${requestScope.PAGE + 1}')" aria-label="Next">
                            <span aria-hidden="true">»</span>
                        </a>
                    </li>
                </ul>
